...
RSpec.describe ReviewableQueuedPost, type: :model do
    ...
    context "actions" do
      ...
      context "approve" do
        ...
        it "creates a post" do
          ...
          expect(result.post).to be_valid
          expect(result.post.topic).to eq(topic)
          expect(result.post.custom_fields['hello']).to eq('world')
  ...
  context "creating a topic" do
    ...
    it "creates the post and topic when approved" do
      ...
      expect(result.topic).to be_valid
    ...
    it "creates the post and topic when rejected" do
      ...
      expect(result.topic).to be_blank
